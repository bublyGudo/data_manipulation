...
```
    ...
    ## ℹ In argument: `group == c("Low7", "Low8")`.
    ## Caused by warning in `group == c("Low7", "Low8")`:
    ## ! longer object length is not a multiple of shorter object length

    ## # A tibble: 7 × 8
    ##   group litter_number gd0_weight gd18_weight gd_of_birth pups_born_alive
    ##   <chr> <chr>              <dbl>       <dbl>       <dbl>           <dbl>
    ## 1 Low7  #107                22.6        42.4          20               9
    ## 2 Low7  #98                 23.8        43.8          20               9
    ## 3 Low7  #101                23.8        42.7          20               9
    ## 4 Low7  #112                23.9        40.5          19               6
    ## 5 Low8  #79                 25.4        43.8          19               8
    ## 6 Low8  #4/84               21.8        35.2          20               4
    ## 7 Low8  #99                 23.5        39            20               6
    ## # ℹ 2 more variables: pups_dead_birth <dbl>, pups_survive <dbl>
